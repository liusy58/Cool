...
%{
  ...
  for the location of tokens */
    ...
    */
    ...
    %type <expressions> no_empty_expression_list;
    ...
    */
    ...
    :
    { $$ = nil_Formals();}
    | no_empty_formal_list
    { $$ = $1;}
    ;

    no_empty_formal_list
    : formal ',' no_empty_formal_list
    ...
    | expression ',' no_empty_expression_list
